...
//    - One for user confirmation (thanking the user)
...
export const EMAILJS_CONFIG = {
  ...
  USER_TEMPLATE_ID: 'YOUR_USER_TEMPLATE_ID', // Template for user confirmation
  ADMIN_TEMPLATE_ID: 'YOUR_ADMIN_TEMPLATE_ID', // Template for admin notification
};

export const ADMIN_EMAIL = 'ssji2006@gmail.com';
export const ADMIN_PHONE = ['9050842890', '9899636013'];
